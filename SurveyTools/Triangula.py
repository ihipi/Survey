...
class Triangula():
    ...
    def Activated(self):
        ...
        #Tools.getTxtTriangle(linies=easygui.ynbox("Vols usar les linies de rotura", "Opcions de triangulacio"))
        Tools.triangula(linies=easygui.ynbox("Vols usar les linies de rotura", "Opcions de triangulacio"))
